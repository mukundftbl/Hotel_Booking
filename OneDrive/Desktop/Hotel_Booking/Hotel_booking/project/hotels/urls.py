...
from .views import hotel_list,hotel_detail,book_room,booking_confirmation,payment_successful
...
urlpatterns = [
    ...
    path('payment_successful/<int:booking_id>/', payment_successful, name='payment_successful'),
]